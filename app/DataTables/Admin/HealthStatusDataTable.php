...
class HealthStatusDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'admin_dashboard.health_statuss.action')
            ->rawColumns([
                'action',
            ]);
    }
     ...
     */
    public function query(HealthStatus $model): QueryBuilder
    {
    ...
    {
        return 'HealthStatus_' . date('YmdHis');
    }
}
