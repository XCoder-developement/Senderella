...
class RequirmentDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'admin_dashboard.requirments.action')
            ->rawColumns([
                'action',
            ]);
    }
     ...
     */
    public function query(Requirment $model): QueryBuilder
    {
    ...
    {
        return 'Requirment_' . date('YmdHis');
    }
}
