...
class MovingPlaceDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'admin_dashboard.moving_places.action')
            ->rawColumns([
                'action',
            ]);
    }
     ...
     */
    public function query(MovingPlace $model): QueryBuilder
    {
    ...
    {
        return 'MovingPlace_' . date('YmdHis');
    }
}
