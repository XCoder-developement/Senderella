...
class MarriageReadinessDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'admin_dashboard.marriage_readinesses.action')
            ->rawColumns([
                'action',
            ]);
    }
     ...
     */
    public function query(MarriageReadiness $model): QueryBuilder
    {
    ...
    {
        return 'MarriageReadiness_' . date('YmdHis');
    }
}
