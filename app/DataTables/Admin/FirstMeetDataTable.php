...
class FirstMeetDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'admin_dashboard.first_meets.action')
            ->rawColumns([
                'action',
            ]);
    }
     ...
     */
    public function query(FirstMeet $model): QueryBuilder
    {
