...
class EleganceStyleDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'admin_dashboard.elegance_styles.action')
            ->rawColumns([
                'action',
            ]);
    }
     ...
     */
    public function query(EleganceStyle $model): QueryBuilder
    {
    ...
    {
        return 'EleganceStyle_' . date('YmdHis');
    }
}
