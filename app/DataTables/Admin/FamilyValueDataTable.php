...
class FamilyValueDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'admin_dashboard.family_values.action')
            ->rawColumns([
                'action',
            ]);
    }
     ...
     */
    public function query(FamilyValue $model): QueryBuilder
    {
    ...
    {
        return 'FamilyValue_' . date('YmdHis');
    }
}
