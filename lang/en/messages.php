...
return [
    ...
    "colors" => "Skin Colors",
    "marriage_readinesses" => "Marriage Readinesses",
    "problem_types" => "Problem Types",
    "problems" => "Problems",
    "block_reasons" => "Block Reasons",
    "packages" => "Packages",
    "setting_description_en" => "Setting Description",
    "setting_description_ar" => "Setting Description",
    "whatsApp" => "Whatsapp",
    ...
    'requests_for_show_image'       => 'requests to show  your image',
