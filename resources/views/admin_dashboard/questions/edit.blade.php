...
@section("page_title", __("messages.edit question"))
@section('content')
    <div class="container">
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label"> {{ __('messages.edit question') }}</h3>
                </div>
            </div>
                        ...
                        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control   @error('question-' . $localeCode) is-invalid @enderror "
                                        required value="{{ $question->translate($localeCode)->question ?? '' }}"
                        ...
                        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('answer-' . $localeCode) is-invalid @enderror" name="answer-{{ $localeCode }}"
                                        rows="5" placeholder="{{ __('messages.answer_' . $localeCode) }}" required>{{ $question->translate($localeCode)->answer ?? '' }}</textarea>
