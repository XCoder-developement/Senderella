...
@section("page_title", __("messages.add question"))
@section('content')
    <div class="container">
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label"> {{ __('messages.add question') }}</h3>
                </div>
            </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control   @error('question-' . $localeCode) is-invalid @enderror "
                                        required value="{{ old('question-' . $localeCode) }}"
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control  @error('answer-' . $localeCode) is-invalid @enderror" name="answer-{{ $localeCode }}"
                                        rows="5" placeholder="{{ __('messages.answer_' . $localeCode) }}" required></textarea>
