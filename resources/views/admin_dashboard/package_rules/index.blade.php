...
@section('page_title', __("messages.package_rules"))
@section('content')
    <div class="container">
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label"> {{ __('messages.edit package_rules') }}</h3>
                </div>
            </div>


            <div class="card-body">
                <form method="post" action="{{ route('package_rules.update') }}" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control  @error('text-' . $localeCode) is-invalid @enderror"
                                        name="text-{{ $localeCode }}" placeholder=" {{ __('messages.text_' . $localeCode) }}  " > {{ $package_rule->translate($localeCode)->text ?? '' }} </textarea>
