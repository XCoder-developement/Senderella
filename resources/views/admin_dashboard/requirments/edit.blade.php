        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label"> {{ __('messages.edit education_type') }}</h3>
                </div>
            </div>


            <div class="card-body">
                <form method="post" action="{{ route('requirments.update', $requirment->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')


                    <div class="row">
                        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $answer_type)
                            <!-- For loop this div -->
                          ...
                          @enderror"
                                        required value="{{ $requirment->translate($localeCode)->title ?? '' }}"
