...
@section('page_title', __("messages.privacy"))
@section('content')
    <div class="container">
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label"> {{ __('messages.edit privacy') }}</h3>
                </div>
            </div>


            <div class="card-body">
                <form method="post" action="{{ route('privacies.update') }}" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control  @error('text-' . $localeCode) is-invalid @enderror"
                                        name="text-{{ $localeCode }}" placeholder=" {{ __('messages.text_' . $localeCode) }}  " > {{ $privacy->translate($localeCode)->text ?? '' }} </textarea>
