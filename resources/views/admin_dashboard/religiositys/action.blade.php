<a href="{{route('religiositys.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletereligiositys({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
                            ...
                            <script>
              function deletereligiositys(id){
 ...
 $.ajaxSetup({
  ...
  confirmButtonreligiosity: '#3085d6',
  cancelButtonreligiosity: '#d33',
