<a href="{{route('packages.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletepackages({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
 ...
 $.ajaxSetup({
  ...
  confirmButtonpackage: '#3085d6',
  cancelButtonpackage: '#d33',
