<a href="{{route('eye_colors.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deleteeye_colors({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
