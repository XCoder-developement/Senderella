        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label"> {{ __('messages.add notification') }}</h3>
                </div>
            </div>
...
<div class="row">
    ...
    @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
        ...
        <div class="col-md-6 col-sm-12">
            <div class="form-group">
                <label>
                    {{ __('messages.body_' . $localeCode) }}

                    <span class="text-danger"> ( {{ $localeCode }} )</span>
                </label>
                <input
                    class="form-control   @error('body-' . $localeCode) is-invalid
      @enderror"
                    required value="{{ old('body-' . $localeCode) }}" name="body-{{ $localeCode }}">
