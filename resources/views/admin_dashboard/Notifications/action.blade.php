<a href="{{route('notifications.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletenotifications({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
