        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label"> {{ __('messages.edit state') }}</h3>
                </div>
            </div>
                ...
                <form method="post" action="{{ route('states.update', $state->id) }}" enctype="multipart/form-data">
                                ...
                                <select
                                    ...
                                    @foreach ($countries as $country)
                                        <option value="{{ $country->id }}"
                                            @if ($country->id == $state->country_id) selected @endif>{{ $country->title }}</option>
                                    @endforeach
                                </select>
                                @error('country_id')
                    ...
                    <div class="row">
                        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                          ...
                          @enderror"
                                        required value="{{ $state->translate($localeCode)->title ?? '' }}"
