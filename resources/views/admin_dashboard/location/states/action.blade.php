<a href="{{route('states.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletestates({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
