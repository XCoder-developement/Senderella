<a href="{{route('countries.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletecountries({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
