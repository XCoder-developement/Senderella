<a href="{{route('text_banners.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletetext_banner({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
