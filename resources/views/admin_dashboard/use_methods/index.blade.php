...
@section('page_title', __("messages.use_method"))
@section('content')
    <div class="container">
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label"> {{ __('messages.edit_use_method') }}</h3>
                </div>
            </div>


            <div class="card-body">
                <form method="post" action="{{ route('use_methods.update') }}" enctype="multipart/form-data">
                    @csrf
