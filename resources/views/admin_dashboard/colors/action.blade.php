<a href="{{route('colors.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletecolors({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
