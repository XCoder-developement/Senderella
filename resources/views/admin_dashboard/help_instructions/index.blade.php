...
@section('page_title', __("messages.help_instruction"))
@section('content')
    <div class="container">
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label"> {{ __('messages.edit_help_instruction') }}</h3>
                </div>
            </div>


            <div class="card-body">
                <form method="post" action="{{ route('help_instructions.update') }}" enctype="multipart/form-data">
                    @csrf
