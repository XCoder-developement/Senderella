<a href="{{route('hair_colors.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletehair_colors({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
