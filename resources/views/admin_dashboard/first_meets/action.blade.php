<a href="{{route('first_meets.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletefirst_meets({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
