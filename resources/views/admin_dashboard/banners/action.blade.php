<a href="{{route('banners.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletebanner({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
