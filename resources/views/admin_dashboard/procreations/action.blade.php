<a href="{{route('procreations.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deleteprocreations({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
                            ...
                            <script>
              function deleteprocreations(id){
 ...
 $.ajaxSetup({
  ...
  confirmButtonprocreation: '#3085d6',
  cancelButtonprocreation: '#d33',
