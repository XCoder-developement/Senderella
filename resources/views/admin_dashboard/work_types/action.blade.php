<a href="{{route('work_types.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletework_types({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
